                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            @if($user->id !== auth()->id())
                                                <form method="POST" action="{{ route('admin.users.toggle-admin', $user) }}" class="inline">
                                                    ...
                                                    @method('PATCH')
                                                    <button type="submit" 
                                                            onclick="return confirm('Are you sure you want to {{ $user->isAdmin() ? 'remove admin access from' : 'grant admin access to' }} {{ $user->name }}?')"
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        ...
                                        <dd class="text-lg font-medium text-gray-900">
                                            {{ $users->filter(function($user) { return $user->isAdmin(); })->count() }}
                                        </dd>
                                    </dl>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        ...
                                        <dd class="text-lg font-medium text-gray-900">
                                            {{ $users->filter(function($user) { return !$user->isAdmin() && $user->tickets()->count() > 0; })->count() }}
                                        </dd>
                                    </dl>
                                </div>
                            </div>
